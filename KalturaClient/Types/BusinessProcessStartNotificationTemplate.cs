...
namespace Kaltura.Types
{
	public class BusinessProcessStartNotificationTemplate : BusinessProcessNotificationTemplate
	{
		...
		#region Properties
		/// <summary>
		/// Use AbortOnDeletionAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public BusinessProcessStartNotificationTemplate(JToken node) : base(node)
		{
			if(node["abortOnDeletion"] != null)
			{
				this._AbortOnDeletion = ParseBool(node["abortOnDeletion"].Value<string>());
			}
		}
		#endregion
