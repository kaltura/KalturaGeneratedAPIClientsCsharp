...
namespace Kaltura
{
	public class KalturaBulkServiceFilterData : KalturaBulkServiceData
	{
		...
		public KalturaBulkServiceFilterData(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			if (this.TemplateObject != null)
				kparams.Add("templateObject", this.TemplateObject.ToParams());
			return kparams;
		}
		#endregion
	}
