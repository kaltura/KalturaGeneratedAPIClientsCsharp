...
namespace Kaltura
{
	public class KalturaScheduledTaskProfileBaseFilter : KalturaFilter
	{
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "systemNameIn":
						...
						continue;
					case "statusEqual":
						this._StatusEqual = (KalturaScheduledTaskProfileStatus)ParseEnum(typeof(KalturaScheduledTaskProfileStatus), txt);
						continue;
					case "statusIn":
						this._StatusIn = txt;
						continue;
					...
					case "lastExecutionStartedAtGreaterThanOrEqual":
						this._LastExecutionStartedAtGreaterThanOrEqual = ParseInt(txt);
						continue;
					case "lastExecutionStartedAtLessThanOrEqual":
						this._LastExecutionStartedAtLessThanOrEqual = ParseInt(txt);
						continue;
				}
			}
		}
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIfNotNull("lastExecutionStartedAtGreaterThanOrEqual", this.LastExecutionStartedAtGreaterThanOrEqual);
			kparams.AddIfNotNull("lastExecutionStartedAtLessThanOrEqual", this.LastExecutionStartedAtLessThanOrEqual);
			return kparams;
		}
		#endregion
	}
