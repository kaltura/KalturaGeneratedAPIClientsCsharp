...
namespace Kaltura
{
	public class KalturaGenericDistributionProfileFilter : KalturaGenericDistributionProfileBaseFilter
	{
		...
		#region Properties
		public KalturaGenericDistributionProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaGenericDistributionProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaGenericDistributionProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaGenericDistributionProfileOrderBy), txt);
						continue;
				}
			}
		}
