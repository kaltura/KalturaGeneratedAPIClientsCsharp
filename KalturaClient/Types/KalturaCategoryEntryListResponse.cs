...
namespace Kaltura
{
	public class KalturaCategoryEntryListResponse : KalturaObjectBase
	{
		...
		public KalturaCategoryEntryListResponse(XmlElement node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			if (this.Objects != null)
			{
				...
				{
					int i = 0;
					foreach (KalturaCategoryEntry item in this.Objects)
					{
