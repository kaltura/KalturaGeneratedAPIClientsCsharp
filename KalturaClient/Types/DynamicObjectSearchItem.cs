...
{
	public class DynamicObjectSearchItem : SearchOperator
	{
		#region Constants
		...
		public DynamicObjectSearchItem(XmlElement node) : base(node)
		{
		...
		public DynamicObjectSearchItem(IDictionary<string,object> data) : base(data)
		{
