...
namespace Kaltura
{
	public class KalturaEmailNotificationStaticRecipientProvider : KalturaEmailNotificationRecipientProvider
	{
		#region Private Fields
		private IList<KalturaEmailNotificationRecipient> _EmailRecipients;
		#endregion
		...
		public KalturaEmailNotificationStaticRecipientProvider(XmlElement node) : base(node)
		{
