...
namespace Kaltura
{
	public class KalturaSwfFlavorParamsFilter : KalturaSwfFlavorParamsBaseFilter
	{
		...
		#region Properties
		public KalturaSwfFlavorParamsOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaSwfFlavorParamsFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaSwfFlavorParamsOrderBy)KalturaStringEnum.Parse(typeof(KalturaSwfFlavorParamsOrderBy), txt);
						continue;
				}
			}
		}
