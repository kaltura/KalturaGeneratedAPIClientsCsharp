...
namespace Kaltura
{
	public class KalturaEntryDistributionFilter : KalturaEntryDistributionBaseFilter
	{
		...
		#region Properties
		public KalturaEntryDistributionOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaEntryDistributionFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaEntryDistributionOrderBy)KalturaStringEnum.Parse(typeof(KalturaEntryDistributionOrderBy), txt);
						continue;
				}
			}
		}
