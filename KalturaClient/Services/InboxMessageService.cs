...
{
	public class InboxMessageGetRequestBuilder : StandaloneRequestBuilder<InboxMessage>
	{
		#region Constants
	...
	public class InboxMessageListRequestBuilder : StandaloneRequestBuilder<ListResponse<InboxMessage>>
	{
		#region Constants
	...
	public class InboxMessageUpdateStatusRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string ID = "id";
