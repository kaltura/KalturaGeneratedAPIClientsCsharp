...
namespace Kaltura.Types
{
	public class AccessControlDrmPolicyAction : RuleAction
	{
		...
		#region Properties
		/// <summary>
		/// Use PolicyIdAsDouble property instead
		/// </summary>
		[JsonProperty]
		public int PolicyId
		{
		...
		public AccessControlDrmPolicyAction(JToken node) : base(node)
		{
			if(node["policyId"] != null)
			{
				this._PolicyId = ParseInt(node["policyId"].Value<string>());
			}
		}
		#endregion
