...
namespace Kaltura.Types
{
	public class EventObjectChangedCondition : Condition
	{
		...
		#region Properties
		/// <summary>
		/// Use ModifiedColumnsAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public EventObjectChangedCondition(JToken node) : base(node)
		{
			if(node["modifiedColumns"] != null)
			{
				this._ModifiedColumns = node["modifiedColumns"].Value<string>();
			}
		}
		#endregion
