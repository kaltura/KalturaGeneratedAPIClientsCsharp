...
{
	public class AnonymousIPCondition : MatchCondition
	{
		#region Constants
		...
		public AnonymousIPCondition(XmlElement node) : base(node)
		{
		...
		public AnonymousIPCondition(IDictionary<string,object> data) : base(data)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaAnonymousIPCondition");
