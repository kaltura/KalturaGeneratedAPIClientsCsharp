...
namespace Kaltura.Types
{
	public class ESearchEntryItem : ESearchAbstractEntryItem
	{
		...
		public ESearchEntryItem(JToken node) : base(node)
		{
			if(node["fieldName"] != null)
			{
				this._FieldName = (ESearchEntryFieldName)StringEnum.Parse(typeof(ESearchEntryFieldName), node["fieldName"].Value<string>());
			}
		}
		#endregion
