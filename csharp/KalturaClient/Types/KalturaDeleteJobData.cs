...
namespace Kaltura
{
	public class KalturaDeleteJobData : KalturaJobData
	{
		...
		public KalturaDeleteJobData(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddReplace("objectType", "KalturaDeleteJobData");
			if (this.Filter != null)
