...
namespace Kaltura
{
	public class KalturaConfigurableDistributionProfileFilter : KalturaConfigurableDistributionProfileBaseFilter
	{
		...
		#region Properties
		public KalturaConfigurableDistributionProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaConfigurableDistributionProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaConfigurableDistributionProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaConfigurableDistributionProfileOrderBy), txt);
						continue;
				}
			}
		}
