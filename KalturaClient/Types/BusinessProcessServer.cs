...
namespace Kaltura.Types
{
	public class BusinessProcessServer : ObjectBase
	{
		...
		public BusinessProcessServer(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				switch (propertyNode.Name)
				{
					...
					case "description":
						...
						continue;
					case "status":
						this._Status = (BusinessProcessServerStatus)StringEnum.Parse(typeof(BusinessProcessServerStatus), propertyNode.InnerText);
						continue;
					case "type":
						this._Type = (BusinessProcessProvider)StringEnum.Parse(typeof(BusinessProcessProvider), propertyNode.InnerText);
						continue;
					case "dc":
