...
namespace Kaltura
{
	public class KalturaLiveStreamEntryFilter : KalturaLiveStreamEntryBaseFilter
	{
		...
		#region Properties
		public KalturaLiveStreamEntryOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaLiveStreamEntryFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaLiveStreamEntryOrderBy)KalturaStringEnum.Parse(typeof(KalturaLiveStreamEntryOrderBy), txt);
						continue;
				}
			}
		}
