...
namespace Kaltura
{
	public class KalturaControlPanelCommandFilter : KalturaControlPanelCommandBaseFilter
	{
		...
		#region Properties
		public KalturaControlPanelCommandOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaControlPanelCommandFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaControlPanelCommandOrderBy)KalturaStringEnum.Parse(typeof(KalturaControlPanelCommandOrderBy), txt);
						continue;
				}
			}
		}
