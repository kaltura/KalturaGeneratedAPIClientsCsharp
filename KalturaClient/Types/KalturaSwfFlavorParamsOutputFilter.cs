...
namespace Kaltura
{
	public class KalturaSwfFlavorParamsOutputFilter : KalturaSwfFlavorParamsOutputBaseFilter
	{
		...
		#region Properties
		public KalturaSwfFlavorParamsOutputOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaSwfFlavorParamsOutputFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaSwfFlavorParamsOutputOrderBy)KalturaStringEnum.Parse(typeof(KalturaSwfFlavorParamsOutputOrderBy), txt);
						continue;
				}
			}
		}
