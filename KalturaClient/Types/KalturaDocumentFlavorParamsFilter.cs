...
namespace Kaltura
{
	public class KalturaDocumentFlavorParamsFilter : KalturaDocumentFlavorParamsBaseFilter
	{
		...
		#region Properties
		public KalturaDocumentFlavorParamsOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaDocumentFlavorParamsFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaDocumentFlavorParamsOrderBy)KalturaStringEnum.Parse(typeof(KalturaDocumentFlavorParamsOrderBy), txt);
						continue;
				}
			}
		}
