...
namespace Kaltura
{
	public class KalturaDeliveryProfileBaseFilter : KalturaFilter
	{
		...
		private KalturaPlaybackProtocol _StreamerTypeEqual = null;
		private KalturaDeliveryStatus _StatusEqual = (KalturaDeliveryStatus)Int32.MinValue;
		...
		public KalturaDeliveryProfileBaseFilter(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddStringEnumIfNotNull("streamerTypeEqual", this.StreamerTypeEqual);
