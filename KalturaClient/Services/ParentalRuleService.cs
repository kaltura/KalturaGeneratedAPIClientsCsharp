...
{
	public class ParentalRuleDisableRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class ParentalRuleDisableDefaultRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string ENTITY_REFERENCE = "entityReference";
		#endregion
	...
	public class ParentalRuleEnableRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string RULE_ID = "ruleId";
		public const string ENTITY_REFERENCE = "entityReference";
	...
	public class ParentalRuleListRequestBuilder : StandaloneRequestBuilder<ListResponse<ParentalRule>>
	{
		#region Constants
