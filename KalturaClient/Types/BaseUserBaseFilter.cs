...
namespace Kaltura.Types
{
	public class BaseUserBaseFilter : RelatedFilter
	{
		...
		/// <summary>
		/// Use ScreenNameLikeAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		/// <summary>
		/// Use ScreenNameStartsWithAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		/// <summary>
		/// Use EmailLikeAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		/// <summary>
		/// Use EmailStartsWithAsDouble property instead
		/// </summary>
		[JsonProperty]
