...
{
	public class CdnAdapterProfileAddRequestBuilder : StandaloneRequestBuilder<CDNAdapterProfile>
	{
		#region Constants
	...
	public class CdnAdapterProfileDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class CdnAdapterProfileGenerateSharedSecretRequestBuilder : StandaloneRequestBuilder<CDNAdapterProfile>
	{
		#region Constants
		public const string ADAPTER_ID = "adapterId";
		#endregion
	...
	public class CdnAdapterProfileListRequestBuilder : StandaloneRequestBuilder<ListResponse<CDNAdapterProfile>>
	{
		#region Constants
		#endregion
	...
	public class CdnAdapterProfileUpdateRequestBuilder : StandaloneRequestBuilder<CDNAdapterProfile>
	{
		#region Constants
		public const string ADAPTER_ID = "adapterId";
		public const string ADAPTER = "adapter";
