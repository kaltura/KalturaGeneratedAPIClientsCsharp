...
namespace Kaltura.Types
{
	public class MetadataReplacementOptionsItem : PluginReplacementOptionsItem
	{
		...
		#region Properties
		/// <summary>
		/// Use ShouldCopyMetadataAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public MetadataReplacementOptionsItem(JToken node) : base(node)
		{
			if(node["shouldCopyMetadata"] != null)
			{
				this._ShouldCopyMetadata = ParseBool(node["shouldCopyMetadata"].Value<string>());
			}
		}
		#endregion
