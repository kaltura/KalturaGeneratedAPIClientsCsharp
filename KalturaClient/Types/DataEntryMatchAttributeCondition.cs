...
namespace Kaltura.Types
{
	public class DataEntryMatchAttributeCondition : SearchMatchAttributeCondition
	{
		...
		public DataEntryMatchAttributeCondition(JToken node) : base(node)
		{
			if(node["attribute"] != null)
			{
				this._Attribute = (DataEntryMatchAttribute)StringEnum.Parse(typeof(DataEntryMatchAttribute), node["attribute"].Value<string>());
			}
		}
		#endregion
