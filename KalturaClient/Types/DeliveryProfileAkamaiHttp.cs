...
namespace Kaltura.Types
{
	public class DeliveryProfileAkamaiHttp : DeliveryProfileHttp
	{
		...
		#region Properties
		/// <summary>
		/// Use UseIntelliseekAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public DeliveryProfileAkamaiHttp(JToken node) : base(node)
		{
			if(node["useIntelliseek"] != null)
			{
				this._UseIntelliseek = ParseBool(node["useIntelliseek"].Value<string>());
			}
		}
		#endregion
