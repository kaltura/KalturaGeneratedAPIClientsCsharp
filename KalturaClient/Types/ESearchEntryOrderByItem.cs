...
{
	public class ESearchEntryOrderByItem : ESearchOrderByItem
	{
		#region Constants
		...
		private ESearchEntryOrderByFieldName _SortField = null;
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaESearchEntryOrderByItem");
