...
namespace Kaltura
{
	public class KalturaPdfFlavorParamsFilter : KalturaPdfFlavorParamsBaseFilter
	{
		...
		#region Properties
		public KalturaPdfFlavorParamsOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaPdfFlavorParamsFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaPdfFlavorParamsOrderBy)KalturaStringEnum.Parse(typeof(KalturaPdfFlavorParamsOrderBy), txt);
						continue;
				}
			}
		}
