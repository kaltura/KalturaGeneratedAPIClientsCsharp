...
namespace Kaltura
{
	public class KalturaFieldMatchCondition : KalturaMatchCondition
	{
		#region Private Fields
		private KalturaStringField _Field;
		#endregion
		...
		public KalturaFieldMatchCondition(XmlElement node) : base(node)
		{
