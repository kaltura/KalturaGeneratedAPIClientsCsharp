...
namespace Kaltura
{
	public class KalturaScheduleEventResourceBaseFilter : KalturaRelatedFilter
	{
		...
		public KalturaScheduleEventResourceBaseFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "eventIdEqual":
						this.EventIdEqual = ParseInt(txt);
						continue;
					case "eventIdIn":
						this.EventIdIn = txt;
						continue;
					case "resourceIdEqual":
						this.ResourceIdEqual = ParseInt(txt);
						continue;
					case "resourceIdIn":
						this.ResourceIdIn = txt;
						continue;
