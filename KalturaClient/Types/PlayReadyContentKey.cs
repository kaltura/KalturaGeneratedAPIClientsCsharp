...
{
	public class PlayReadyContentKey : ObjectBase
	{
		#region Constants
		public const string KEY_ID = "keyId";
		public const string CONTENT_KEY = "contentKey";
		#endregion
		...
		/// <summary>
		/// Use ContentKeyAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			kparams.AddIfNotNull("contentKey", this._ContentKey);
			return kparams;
		}
