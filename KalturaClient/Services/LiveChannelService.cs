...
namespace Kaltura.Services
{
	...
	public class LiveChannelDeleteRequestBuilder : RequestBuilder<VoidResponse>
	{
		#region Constants
	...
	public class LiveChannelValidateRegisteredMediaServersRequestBuilder : RequestBuilder<VoidResponse>
	{
		#region Constants
		public const string ENTRY_ID = "entryId";
		#endregion
