...
{
	public class DropFolderFilter : DropFolderBaseFilter
	{
		#region Constants
		...
		private DropFolderOrderBy _OrderBy = null;
		#endregion
		...
		public DropFolderFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "currentDc":
						this._CurrentDc = (NullableBoolean)ParseEnum(typeof(NullableBoolean), txt);
						continue;
					case "orderBy":
						this._OrderBy = (DropFolderOrderBy)StringEnum.Parse(typeof(DropFolderOrderBy), txt);
						continue;
				}
			}
		}
