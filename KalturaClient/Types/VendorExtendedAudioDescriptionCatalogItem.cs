...
{
	public class VendorExtendedAudioDescriptionCatalogItem : VendorCatalogItem
	{
		#region Constants
		...
		public VendorExtendedAudioDescriptionCatalogItem(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaVendorExtendedAudioDescriptionCatalogItem");
