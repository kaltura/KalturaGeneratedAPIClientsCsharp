			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "partnerIdIn":
						...
						continue;
					case "isDefaultEqual":
						this._IsDefaultEqual = (NullableBoolean)ParseEnum(typeof(NullableBoolean), txt);
						continue;
					case "isDefaultIn":
						this._IsDefaultIn = txt;
						continue;
					case "statusEqual":
						this._StatusEqual = (GenericDistributionProviderStatus)ParseEnum(typeof(GenericDistributionProviderStatus), txt);
						continue;
					case "statusIn":
						this._StatusIn = txt;
						continue;
