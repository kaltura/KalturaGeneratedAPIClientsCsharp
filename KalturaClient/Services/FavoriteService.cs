...
{
	public class FavoriteAddRequestBuilder : StandaloneRequestBuilder<Favorite>
	{
		#region Constants
	...
	public class FavoriteDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class FavoriteListRequestBuilder : StandaloneRequestBuilder<ListResponse<Favorite>>
	{
		#region Constants
