...
{
	public class DeliveryProfileGenericHttp : DeliveryProfile
	{
		#region Constants
		...
		public DeliveryProfileGenericHttp(XmlElement node) : base(node)
		{
		...
		public DeliveryProfileGenericHttp(IDictionary<string,object> data) : base(data)
		{
