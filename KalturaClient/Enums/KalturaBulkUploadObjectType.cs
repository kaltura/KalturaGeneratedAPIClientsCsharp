...
namespace Kaltura
{
	public sealed class KalturaBulkUploadObjectType : KalturaStringEnum
	{
		...
		public static readonly KalturaBulkUploadObjectType CATEGORY_USER = new KalturaBulkUploadObjectType("4");
		public static readonly KalturaBulkUploadObjectType CATEGORY_ENTRY = new KalturaBulkUploadObjectType("5");

		private KalturaBulkUploadObjectType(string name) : base(name) { }
	}
}
