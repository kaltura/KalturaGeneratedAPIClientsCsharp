...
{
	public class DistributionValidationErrorMissingMetadata : DistributionValidationError
	{
		#region Constants
		...
		public DistributionValidationErrorMissingMetadata(XmlElement node) : base(node)
		{
