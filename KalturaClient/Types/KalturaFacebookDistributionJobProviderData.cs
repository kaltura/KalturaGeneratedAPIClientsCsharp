...
namespace Kaltura
{
	public class KalturaFacebookDistributionJobProviderData : KalturaConfigurableDistributionJobProviderData
	{
		#region Private Fields
		private string _VideoAssetFilePath = null;
		private string _ThumbAssetFilePath = null;
		private IList<KalturaFacebookCaptionDistributionInfo> _CaptionsInfo;
		#endregion
		...
		public new IList<KalturaFacebookCaptionDistributionInfo> CaptionsInfo
		{
		...
		public KalturaFacebookDistributionJobProviderData(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "thumbAssetFilePath":
						...
						continue;
					case "captionsInfo":
						this._CaptionsInfo = new List<KalturaFacebookCaptionDistributionInfo>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._CaptionsInfo.Add((KalturaFacebookCaptionDistributionInfo)KalturaObjectFactory.Create(arrayNode, "KalturaFacebookCaptionDistributionInfo"));
						}
						continue;
				}
			}
