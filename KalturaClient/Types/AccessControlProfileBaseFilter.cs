...
{
	public class AccessControlProfileBaseFilter : RelatedFilter
	{
		#region Constants
		...
		public AccessControlProfileBaseFilter(XmlElement node) : base(node)
		{
		...
		public AccessControlProfileBaseFilter(IDictionary<string,object> data) : base(data)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaAccessControlProfileBaseFilter");
