...
namespace Kaltura
{
	public class KalturaHttpNotificationTemplate : KalturaEventNotificationTemplate
	{
		#region Private Fields
		private string _Url = null;
		private KalturaHttpNotificationMethod _Method = (KalturaHttpNotificationMethod)Int32.MinValue;
		private KalturaHttpNotificationData _Data;
		...
		public KalturaHttpNotificationTemplate(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "method":
						...
						continue;
					case "data":
						this._Data = (KalturaHttpNotificationData)KalturaObjectFactory.Create(propertyNode, "KalturaHttpNotificationData");
						continue;
					case "timeout":
