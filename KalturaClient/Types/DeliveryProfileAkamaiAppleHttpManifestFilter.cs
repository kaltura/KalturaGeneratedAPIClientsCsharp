...
namespace Kaltura.Types
{
	public class DeliveryProfileAkamaiAppleHttpManifestFilter : DeliveryProfileAkamaiAppleHttpManifestBaseFilter
	{
		...
		public DeliveryProfileAkamaiAppleHttpManifestFilter(JToken node) : base(node)
		{
			if(node["orderBy"] != null)
			{
				this._OrderBy = (DeliveryProfileAkamaiAppleHttpManifestOrderBy)StringEnum.Parse(typeof(DeliveryProfileAkamaiAppleHttpManifestOrderBy), node["orderBy"].Value<string>());
			}
		}
		#endregion
