...
namespace Kaltura
{
	public class KalturaSyndicationDistributionProfileFilter : KalturaSyndicationDistributionProfileBaseFilter
	{
		...
		#region Properties
		public KalturaSyndicationDistributionProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaSyndicationDistributionProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaSyndicationDistributionProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaSyndicationDistributionProfileOrderBy), txt);
						continue;
				}
			}
		}
