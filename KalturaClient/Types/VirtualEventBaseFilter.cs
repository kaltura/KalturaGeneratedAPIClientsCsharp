...
{
	public class VirtualEventBaseFilter : Filter
	{
		#region Constants
		...
		private VirtualEventStatus _StatusEqual = (VirtualEventStatus)Int32.MinValue;
		...
		/// </summary>
		[JsonProperty]
		public VirtualEventStatus StatusEqual
		{
		...
		public VirtualEventBaseFilter(JToken node) : base(node)
		{
			...
			{
				this._StatusEqual = (VirtualEventStatus)ParseEnum(typeof(VirtualEventStatus), node["statusEqual"].Value<string>());
			}
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaVirtualEventBaseFilter");
