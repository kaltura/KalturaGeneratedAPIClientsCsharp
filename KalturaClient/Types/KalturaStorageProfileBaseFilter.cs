...
namespace Kaltura
{
	public class KalturaStorageProfileBaseFilter : KalturaFilter
	{
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "statusIn":
						...
						continue;
					case "protocolEqual":
						this.ProtocolEqual = (KalturaStorageProfileProtocol)KalturaStringEnum.Parse(typeof(KalturaStorageProfileProtocol), txt);
						continue;
					case "protocolIn":
						this.ProtocolIn = txt;
						continue;
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddStringEnumIfNotNull("protocolEqual", this.ProtocolEqual);
