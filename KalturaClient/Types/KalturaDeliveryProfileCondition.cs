...
namespace Kaltura
{
	public class KalturaDeliveryProfileCondition : KalturaCondition
	{
		#region Private Fields
		private IList<KalturaIntegerValue> _DeliveryProfileIds;
		#endregion
		...
		public KalturaDeliveryProfileCondition(XmlElement node) : base(node)
		{
