...
{
	public class CdnPartnerSettingsGetRequestBuilder : StandaloneRequestBuilder<CDNPartnerSettings>
	{
		#region Constants
		#endregion
	...
	public class CdnPartnerSettingsUpdateRequestBuilder : StandaloneRequestBuilder<CDNPartnerSettings>
	{
		#region Constants
