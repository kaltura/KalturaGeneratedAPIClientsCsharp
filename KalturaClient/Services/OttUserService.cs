...
{
	public class OttUserActivateRequestBuilder : StandaloneRequestBuilder<OTTUser>
	{
		#region Constants
	...
	public class OttUserAddRoleRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class OttUserAnonymousLoginRequestBuilder : StandaloneRequestBuilder<LoginSession>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
	...
	public class OttUserDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		#endregion
	...
	public class OttUserGetRequestBuilder : StandaloneRequestBuilder<OTTUser>
	{
		#region Constants
		#endregion
	...
	public class OttUserGetEncryptedUserIdRequestBuilder : StandaloneRequestBuilder<StringValue>
	{
		#region Constants
		#endregion
	...
	public class OttUserListRequestBuilder : StandaloneRequestBuilder<ListResponse<OTTUser>>
	{
		#region Constants
	...
	public class OttUserLoginRequestBuilder : StandaloneRequestBuilder<LoginResponse>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
		public const string USERNAME = "username";
	...
	public class OttUserLoginWithPinRequestBuilder : StandaloneRequestBuilder<LoginResponse>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
	...
	public class OttUserLogoutRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		#endregion
	...
	public class OttUserRefreshSessionRequestBuilder : StandaloneRequestBuilder<LoginSession>
	{
		#region Constants
		...
		public OttUserRefreshSessionRequestBuilder()
			: base("ottuser", "refreshSession")
		{
		}

		public OttUserRefreshSessionRequestBuilder(string refreshToken, string udid)
			: this()
		{
		...
		{
			Params kparams = base.getParameters(includeServiceAndAction);
			if (!isMapped("refreshToken"))
				kparams.AddIfNotNull("refreshToken", RefreshToken);
			if (!isMapped("udid"))
				kparams.AddIfNotNull("udid", Udid);
			return kparams;
		}
	...
	public class OttUserRegisterRequestBuilder : StandaloneRequestBuilder<OTTUser>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
	...
	public class OttUserResendActivationTokenRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
		public const string USERNAME = "username";
	...
	public class OttUserResetPasswordRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
		public const string USERNAME = "username";
	...
	public class OttUserSetInitialPasswordRequestBuilder : StandaloneRequestBuilder<OTTUser>
	{
		#region Constants
		public const string PARTNER_ID = "partnerId";
	...
	public class OttUserUpdateRequestBuilder : StandaloneRequestBuilder<OTTUser>
	{
		#region Constants
		public const string USER = "user";
		#endregion
		...
		public OttUserUpdateRequestBuilder(OTTUser user)
			: this()
		{
			this.User = user;
		}
	...
	public class OttUserUpdateLoginDataRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string USERNAME = "username";
	...
	public class OttUserService
	{
		...
		public static OttUserListRequestBuilder List(OTTUserFilter filter)
		{
		...
		public static OttUserRefreshSessionRequestBuilder RefreshSession(string refreshToken, string udid = null)
		{
			return new OttUserRefreshSessionRequestBuilder(refreshToken, udid);
		}
		...
		public static OttUserUpdateRequestBuilder Update(OTTUser user)
		{
			return new OttUserUpdateRequestBuilder(user);
		}
