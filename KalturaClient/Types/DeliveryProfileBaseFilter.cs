			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "streamerTypeEqual":
						this._StreamerTypeEqual = (PlaybackProtocol)StringEnum.Parse(typeof(PlaybackProtocol), txt);
						continue;
					case "statusEqual":
						this._StatusEqual = (DeliveryStatus)ParseEnum(typeof(DeliveryStatus), txt);
						continue;
					case "statusIn":
						this._StatusIn = txt;
						continue;
