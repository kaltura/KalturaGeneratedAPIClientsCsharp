...
{
	public class FollowTvSeriesAddRequestBuilder : StandaloneRequestBuilder<FollowTvSeries>
	{
		#region Constants
	...
	public class FollowTvSeriesDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class FollowTvSeriesListRequestBuilder : StandaloneRequestBuilder<ListResponse<FollowTvSeries>>
	{
		#region Constants
