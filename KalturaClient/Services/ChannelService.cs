...
{
	public class ChannelAddRequestBuilder : StandaloneRequestBuilder<Channel>
	{
		#region Constants
	...
	public class ChannelDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class ChannelGetRequestBuilder : StandaloneRequestBuilder<Channel>
	{
		#region Constants
	...
	public class ChannelUpdateRequestBuilder : StandaloneRequestBuilder<Channel>
	{
		#region Constants
		public const string CHANNEL_ID = "channelId";
		public const string CHANNEL = "channel";
