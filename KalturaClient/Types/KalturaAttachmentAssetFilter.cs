...
namespace Kaltura
{
	public class KalturaAttachmentAssetFilter : KalturaAttachmentAssetBaseFilter
	{
		...
		#region Properties
		public KalturaAttachmentAssetOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaAttachmentAssetFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaAttachmentAssetOrderBy)KalturaStringEnum.Parse(typeof(KalturaAttachmentAssetOrderBy), txt);
						continue;
				}
			}
		}
