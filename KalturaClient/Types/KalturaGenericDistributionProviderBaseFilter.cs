...
namespace Kaltura
{
	public class KalturaGenericDistributionProviderBaseFilter : KalturaDistributionProviderFilter
	{
		...
		private KalturaNullableBoolean _IsDefaultEqual = (KalturaNullableBoolean)Int32.MinValue;
		private string _IsDefaultIn = null;
		private KalturaGenericDistributionProviderStatus _StatusEqual = (KalturaGenericDistributionProviderStatus)Int32.MinValue;
		...
		public KalturaGenericDistributionProviderBaseFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "partnerIdIn":
						...
						continue;
					case "isDefaultEqual":
						this.IsDefaultEqual = (KalturaNullableBoolean)ParseEnum(typeof(KalturaNullableBoolean), txt);
						continue;
					case "isDefaultIn":
						this.IsDefaultIn = txt;
						continue;
					case "statusEqual":
						this.StatusEqual = (KalturaGenericDistributionProviderStatus)ParseEnum(typeof(KalturaGenericDistributionProviderStatus), txt);
						continue;
					case "statusIn":
						this.StatusIn = txt;
						continue;
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddEnumIfNotNull("isDefaultEqual", this.IsDefaultEqual);
