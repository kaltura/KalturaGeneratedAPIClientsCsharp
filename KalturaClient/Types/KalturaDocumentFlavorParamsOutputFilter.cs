...
namespace Kaltura
{
	public class KalturaDocumentFlavorParamsOutputFilter : KalturaDocumentFlavorParamsOutputBaseFilter
	{
		...
		#region Properties
		public KalturaDocumentFlavorParamsOutputOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaDocumentFlavorParamsOutputFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaDocumentFlavorParamsOutputOrderBy)KalturaStringEnum.Parse(typeof(KalturaDocumentFlavorParamsOutputOrderBy), txt);
						continue;
				}
			}
		}
