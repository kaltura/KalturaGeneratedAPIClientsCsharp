...
{
	public class AssetCommentAddRequestBuilder : StandaloneRequestBuilder<AssetComment>
	{
		#region Constants
	...
	public class AssetCommentListRequestBuilder : StandaloneRequestBuilder<ListResponse<AssetComment>>
	{
		#region Constants
