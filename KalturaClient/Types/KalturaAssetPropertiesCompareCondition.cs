...
namespace Kaltura
{
	public class KalturaAssetPropertiesCompareCondition : KalturaCondition
	{
		...
		#region Properties
		public new IList<KalturaKeyValue> Properties
		{
		...
		public KalturaAssetPropertiesCompareCondition(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "properties":
						this._Properties = new List<KalturaKeyValue>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._Properties.Add((KalturaKeyValue)KalturaObjectFactory.Create(arrayNode, "KalturaKeyValue"));
						}
						continue;
				}
			}
