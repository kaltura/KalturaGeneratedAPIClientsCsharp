...
{
	public class BookmarkAddRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class BookmarkListRequestBuilder : StandaloneRequestBuilder<ListResponse<Bookmark>>
	{
		#region Constants
