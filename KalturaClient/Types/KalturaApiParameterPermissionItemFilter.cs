...
namespace Kaltura
{
	public class KalturaApiParameterPermissionItemFilter : KalturaApiParameterPermissionItemBaseFilter
	{
		...
		#region Properties
		public KalturaApiParameterPermissionItemOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaApiParameterPermissionItemFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaApiParameterPermissionItemOrderBy)KalturaStringEnum.Parse(typeof(KalturaApiParameterPermissionItemOrderBy), txt);
						continue;
				}
			}
		}
