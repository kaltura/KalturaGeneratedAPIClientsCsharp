...
namespace Kaltura
{
	public class KalturaUserEntryListResponse : KalturaListResponse
	{
		...
		#region Properties
		public new IList<KalturaUserEntry> Objects
		{
			get { return _Objects; }
		}
		#endregion
		...
		public KalturaUserEntryListResponse(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "objects":
						this._Objects = new List<KalturaUserEntry>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._Objects.Add((KalturaUserEntry)KalturaObjectFactory.Create(arrayNode, "KalturaUserEntry"));
						}
						continue;
				}
			}
