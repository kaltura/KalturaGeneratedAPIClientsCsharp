...
namespace Kaltura
{
	public class KalturaGenericDistributionProviderActionFilter : KalturaGenericDistributionProviderActionBaseFilter
	{
		...
		#region Properties
		public KalturaGenericDistributionProviderActionOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaGenericDistributionProviderActionFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaGenericDistributionProviderActionOrderBy)KalturaStringEnum.Parse(typeof(KalturaGenericDistributionProviderActionOrderBy), txt);
						continue;
				}
			}
		}
