...
namespace Kaltura
{
	public class KalturaVirusScanProfileFilter : KalturaVirusScanProfileBaseFilter
	{
		...
		#region Properties
		public KalturaVirusScanProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaVirusScanProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaVirusScanProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaVirusScanProfileOrderBy), txt);
						continue;
				}
			}
		}
