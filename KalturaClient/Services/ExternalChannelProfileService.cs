...
{
	public class ExternalChannelProfileAddRequestBuilder : StandaloneRequestBuilder<ExternalChannelProfile>
	{
		#region Constants
	...
	public class ExternalChannelProfileDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class ExternalChannelProfileListRequestBuilder : StandaloneRequestBuilder<ListResponse<ExternalChannelProfile>>
	{
		#region Constants
		#endregion
	...
	public class ExternalChannelProfileUpdateRequestBuilder : StandaloneRequestBuilder<ExternalChannelProfile>
	{
		#region Constants
		public const string EXTERNAL_CHANNEL_ID = "externalChannelId";
		public const string EXTERNAL_CHANNEL = "externalChannel";
