...
{
	public class NotificationsSettingsGetRequestBuilder : StandaloneRequestBuilder<NotificationsSettings>
	{
		#region Constants
		#endregion
	...
	public class NotificationsSettingsUpdateRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
