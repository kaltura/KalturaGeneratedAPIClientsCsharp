...
namespace Kaltura.Services
{
	public class AccessControlAddRequestBuilder : RequestBuilder<AccessControl>
	{
		...
		{
			return ObjectFactory.Create<AccessControl>((IDictionary<string,object>)result);
		}
	}
	...
	public class AccessControlListRequestBuilder : RequestBuilder<ListResponse<AccessControl>>
	{
		...
		public override object DeserializeObject(object result)
		{
			return ObjectFactory.Create<ListResponse<AccessControl>>((IDictionary<string,object>)result);
		}
	}
