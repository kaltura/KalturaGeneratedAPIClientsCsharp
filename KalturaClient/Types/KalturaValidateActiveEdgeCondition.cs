...
namespace Kaltura
{
	public class KalturaValidateActiveEdgeCondition : KalturaCondition
	{
		...
		public KalturaValidateActiveEdgeCondition(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddReplace("objectType", "KalturaValidateActiveEdgeCondition");
