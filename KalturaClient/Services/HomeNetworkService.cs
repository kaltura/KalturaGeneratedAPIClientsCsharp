...
{
	public class HomeNetworkAddRequestBuilder : StandaloneRequestBuilder<HomeNetwork>
	{
		#region Constants
	...
	public class HomeNetworkDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class HomeNetworkListRequestBuilder : StandaloneRequestBuilder<ListResponse<HomeNetwork>>
	{
		#region Constants
		#endregion
	...
	public class HomeNetworkUpdateRequestBuilder : StandaloneRequestBuilder<HomeNetwork>
	{
		#region Constants
		public const string EXTERNAL_ID = "externalId";
		public const string HOME_NETWORK = "homeNetwork";
