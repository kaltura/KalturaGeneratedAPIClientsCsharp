...
namespace Kaltura
{
	public class KalturaScheduleResourceListResponse : KalturaListResponse
	{
		...
		#region Properties
		public new IList<KalturaScheduleResource> Objects
		{
			get { return _Objects; }
		}
		#endregion
		...
		public KalturaScheduleResourceListResponse(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "objects":
						this._Objects = new List<KalturaScheduleResource>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._Objects.Add((KalturaScheduleResource)KalturaObjectFactory.Create(arrayNode, "KalturaScheduleResource"));
						}
						continue;
				}
			}
