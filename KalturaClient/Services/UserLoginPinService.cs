...
{
	public class UserLoginPinAddRequestBuilder : StandaloneRequestBuilder<UserLoginPin>
	{
		#region Constants
	...
	public class UserLoginPinDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class UserLoginPinDeleteAllRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		#endregion
	...
	public class UserLoginPinUpdateRequestBuilder : StandaloneRequestBuilder<UserLoginPin>
	{
		#region Constants
		public const string PIN_CODE = "pinCode";
		public const string SECRET = "secret";
