...
namespace Kaltura
{
	public class KalturaResponseProfile : KalturaDetachedResponseProfile
	{
		...
		public KalturaResponseProfile(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "updatedAt":
						...
						continue;
					case "status":
						this._Status = (KalturaResponseProfileStatus)ParseEnum(typeof(KalturaResponseProfileStatus), txt);
						continue;
					case "version":
