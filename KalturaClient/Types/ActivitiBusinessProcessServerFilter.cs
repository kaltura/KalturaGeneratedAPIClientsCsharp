...
namespace Kaltura.Types
{
	public class ActivitiBusinessProcessServerFilter : ActivitiBusinessProcessServerBaseFilter
	{
		...
		public ActivitiBusinessProcessServerFilter(JToken node) : base(node)
		{
			if(node["orderBy"] != null)
			{
				this._OrderBy = (ActivitiBusinessProcessServerOrderBy)StringEnum.Parse(typeof(ActivitiBusinessProcessServerOrderBy), node["orderBy"].Value<string>());
			}
		}
		#endregion
