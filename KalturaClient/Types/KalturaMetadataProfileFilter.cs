...
namespace Kaltura
{
	public class KalturaMetadataProfileFilter : KalturaMetadataProfileBaseFilter
	{
		...
		#region Properties
		public KalturaMetadataProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaMetadataProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaMetadataProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaMetadataProfileOrderBy), txt);
						continue;
				}
			}
		}
