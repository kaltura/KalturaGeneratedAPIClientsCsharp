...
{
	public class CoordinatesContextField : StringField
	{
		#region Constants
		...
		public CoordinatesContextField(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "geoCoderType":
						this._GeoCoderType = (GeoCoderType)StringEnum.Parse(typeof(GeoCoderType), txt);
						continue;
				}
			}
		}
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaCoordinatesContextField");
