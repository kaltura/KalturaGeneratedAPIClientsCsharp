...
{
	public class WatchLaterUserEntryAdvancedFilter : SearchItem
	{
		#region Constants
		...
		public WatchLaterUserEntryAdvancedFilter(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaWatchLaterUserEntryAdvancedFilter");
