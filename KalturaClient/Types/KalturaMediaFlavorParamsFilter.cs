...
namespace Kaltura
{
	public class KalturaMediaFlavorParamsFilter : KalturaMediaFlavorParamsBaseFilter
	{
		...
		#region Properties
		public KalturaMediaFlavorParamsOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaMediaFlavorParamsFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaMediaFlavorParamsOrderBy)KalturaStringEnum.Parse(typeof(KalturaMediaFlavorParamsOrderBy), txt);
						continue;
				}
			}
		}
