...
namespace Kaltura
{
	public class KalturaGenericSyndicationFeedFilter : KalturaGenericSyndicationFeedBaseFilter
	{
		...
		#region Properties
		public KalturaGenericSyndicationFeedOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaGenericSyndicationFeedFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaGenericSyndicationFeedOrderBy)KalturaStringEnum.Parse(typeof(KalturaGenericSyndicationFeedOrderBy), txt);
						continue;
				}
			}
		}
