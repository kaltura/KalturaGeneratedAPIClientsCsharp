...
namespace Kaltura.Types
{
	public class ConfigurableDistributionJobProviderData : DistributionJobProviderData
	{
		...
		#region Properties
		/// <summary>
		/// Use FieldValuesAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public ConfigurableDistributionJobProviderData(JToken node) : base(node)
		{
			if(node["fieldValues"] != null)
			{
				this._FieldValues = node["fieldValues"].Value<string>();
			}
		}
		#endregion
