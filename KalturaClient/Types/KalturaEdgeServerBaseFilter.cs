...
namespace Kaltura
{
	public class KalturaEdgeServerBaseFilter : KalturaFilter
	{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIfNotNull("playbackHostNameLike", this.PlaybackHostNameLike);
			kparams.AddIfNotNull("playbackHostNameMultiLikeOr", this.PlaybackHostNameMultiLikeOr);
			kparams.AddIfNotNull("playbackHostNameMultiLikeAnd", this.PlaybackHostNameMultiLikeAnd);
