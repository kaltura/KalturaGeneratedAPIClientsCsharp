...
namespace Kaltura
{
	public class KalturaPermissionBaseFilter : KalturaFilter
	{
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "idIn":
						...
						continue;
					case "typeEqual":
						this.TypeEqual = (KalturaPermissionType)ParseEnum(typeof(KalturaPermissionType), txt);
						continue;
					case "typeIn":
						this.TypeIn = txt;
						continue;
					...
					case "descriptionLike":
						...
						continue;
					case "statusEqual":
						this.StatusEqual = (KalturaPermissionStatus)ParseEnum(typeof(KalturaPermissionStatus), txt);
						continue;
					case "statusIn":
						this.StatusIn = txt;
						continue;
