...
namespace Kaltura.Tester
{
    ...
    {
         private const int PARTNER_ID = 2141161; //enter your partner id
        private const string ADMIN_SECRET = "9342e4146b0a59a20696e27dd9773b03"; //enter your admin secret
        private const string SERVICE_URL = "http://kaltura.com/";
