...
{
	public class PurchaseSettingsGetRequestBuilder : StandaloneRequestBuilder<PurchaseSettings>
	{
		#region Constants
	...
	public class PurchaseSettingsUpdateRequestBuilder : StandaloneRequestBuilder<PurchaseSettings>
	{
		#region Constants
