...
{
	public class SeriesRecordingAddRequestBuilder : StandaloneRequestBuilder<SeriesRecording>
	{
		#region Constants
	...
	public class SeriesRecordingCancelRequestBuilder : StandaloneRequestBuilder<SeriesRecording>
	{
		#region Constants
	...
	public class SeriesRecordingCancelByEpgIdRequestBuilder : StandaloneRequestBuilder<SeriesRecording>
	{
		#region Constants
		public const string ID = "id";
	...
	public class SeriesRecordingCancelBySeasonNumberRequestBuilder : StandaloneRequestBuilder<SeriesRecording>
	{
		#region Constants
		public const string ID = "id";
	...
	public class SeriesRecordingDeleteRequestBuilder : StandaloneRequestBuilder<SeriesRecording>
	{
		#region Constants
		public const string ID = "id";
		#endregion
	...
	public class SeriesRecordingDeleteBySeasonNumberRequestBuilder : StandaloneRequestBuilder<SeriesRecording>
	{
		#region Constants
		public const string ID = "id";
		public const string SEASON_NUMBER = "seasonNumber";
	...
	public class SeriesRecordingListRequestBuilder : StandaloneRequestBuilder<ListResponse<SeriesRecording>>
	{
		#region Constants
