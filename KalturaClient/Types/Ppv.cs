...
namespace Kaltura.Types
{
	public class Ppv : ObjectBase
	{
		...
		public const string DISCOUNT_MODULES = "discountModules";
		...
		private DiscountModule _DiscountModules;
		...
		public DiscountModule DiscountModules
		{
			get { return _DiscountModules; }
			set 
			{ 
				_DiscountModules = value;
				OnPropertyChanged("DiscountModules");
			}
		}
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			kparams.AddIfNotNull("discountModules", this._DiscountModules);
