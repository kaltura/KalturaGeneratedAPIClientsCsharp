...
{
	public class NotificationsPartnerSettingsGetRequestBuilder : StandaloneRequestBuilder<NotificationsPartnerSettings>
	{
		#region Constants
		#endregion
	...
	public class NotificationsPartnerSettingsUpdateRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
