...
namespace Kaltura
{
	public class KalturaShortLinkBaseFilter : KalturaFilter
	{
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "systemNameIn":
						...
						continue;
					case "statusEqual":
						this._StatusEqual = (KalturaShortLinkStatus)ParseEnum(typeof(KalturaShortLinkStatus), txt);
						continue;
					case "statusIn":
						this._StatusIn = txt;
						continue;
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIfNotNull("expiresAtGreaterThanOrEqual", this.ExpiresAtGreaterThanOrEqual);
			kparams.AddIfNotNull("expiresAtLessThanOrEqual", this.ExpiresAtLessThanOrEqual);
