...
{
	public class PinGetRequestBuilder : StandaloneRequestBuilder<Pin>
	{
		#region Constants
	...
	public class PinUpdateRequestBuilder : StandaloneRequestBuilder<Pin>
	{
		#region Constants
		public const string BY = "by";
		public const string TYPE = "type";
	...
	public class PinValidateRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string PIN = "pin";
		public const string TYPE = "type";
