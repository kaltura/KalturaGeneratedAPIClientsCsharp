...
namespace Kaltura
{
	public class KalturaBaseEntryBaseFilter : KalturaRelatedFilter
	{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddStringIfNotNull("creatorIdEqual", this.CreatorIdEqual);
			...
			kparams.AddStringIfNotNull("categoriesNotContains", this.CategoriesNotContains);
			...
			kparams.AddStringIfNotNull("categoriesIdsNotContains", this.CategoriesIdsNotContains);
			kparams.AddEnumIfNotNull("categoriesIdsEmpty", this.CategoriesIdsEmpty);
			...
			kparams.AddIntIfNotNull("totalRankLessThanOrEqual", this.TotalRankLessThanOrEqual);
			kparams.AddIntIfNotNull("totalRankGreaterThanOrEqual", this.TotalRankGreaterThanOrEqual);
