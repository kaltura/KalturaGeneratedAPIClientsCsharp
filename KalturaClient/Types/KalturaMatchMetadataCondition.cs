...
namespace Kaltura
{
	public class KalturaMatchMetadataCondition : KalturaMatchCondition
	{
		...
		public KalturaMatchMetadataCondition(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIntIfNotNull("profileId", this.ProfileId);
			kparams.AddStringIfNotNull("profileSystemName", this.ProfileSystemName);
			return kparams;
		}
		#endregion
	}
