...
namespace Kaltura.Enums
{
	public sealed class EntryVendorTaskOrderBy : StringEnum
	{
		...
		public static readonly EntryVendorTaskOrderBy EXPECTED_FINISH_TIME_ASC = new EntryVendorTaskOrderBy("+expectedFinishTime");
		...
		public static readonly EntryVendorTaskOrderBy EXPECTED_FINISH_TIME_DESC = new EntryVendorTaskOrderBy("-expectedFinishTime");
