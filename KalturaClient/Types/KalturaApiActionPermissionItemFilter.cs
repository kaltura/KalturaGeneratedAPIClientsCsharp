...
namespace Kaltura
{
	public class KalturaApiActionPermissionItemFilter : KalturaApiActionPermissionItemBaseFilter
	{
		...
		#region Properties
		public KalturaApiActionPermissionItemOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaApiActionPermissionItemFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaApiActionPermissionItemOrderBy)KalturaStringEnum.Parse(typeof(KalturaApiActionPermissionItemOrderBy), txt);
						continue;
				}
			}
		}
