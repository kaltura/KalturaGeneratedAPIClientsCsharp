...
namespace Kaltura
{
	public class KalturaYoutubeApiDistributionProviderFilter : KalturaYoutubeApiDistributionProviderBaseFilter
	{
		...
		#region Properties
		public KalturaYoutubeApiDistributionProviderOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaYoutubeApiDistributionProviderFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaYoutubeApiDistributionProviderOrderBy)KalturaStringEnum.Parse(typeof(KalturaYoutubeApiDistributionProviderOrderBy), txt);
						continue;
				}
			}
		}
