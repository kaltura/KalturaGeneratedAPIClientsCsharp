...
{
	public class TimeShiftedTvPartnerSettingsGetRequestBuilder : StandaloneRequestBuilder<TimeShiftedTvPartnerSettings>
	{
		#region Constants
		#endregion
	...
	public class TimeShiftedTvPartnerSettingsUpdateRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
