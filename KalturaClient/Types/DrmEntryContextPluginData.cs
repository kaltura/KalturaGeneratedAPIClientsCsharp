...
namespace Kaltura.Types
{
	public class DrmEntryContextPluginData : PluginData
	{
		...
		#region Properties
		/// <summary>
		/// Use FlavorDataAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public DrmEntryContextPluginData(JToken node) : base(node)
		{
			if(node["flavorData"] != null)
			{
				this._FlavorData = node["flavorData"].Value<string>();
			}
		}
		#endregion
