...
{
	public class SearchCondition : SearchItem
	{
		#region Constants
		...
		public SearchCondition(XmlElement node) : base(node)
		{
		...
		public SearchCondition(IDictionary<string,object> data) : base(data)
		{
