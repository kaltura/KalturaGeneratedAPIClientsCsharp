...
{
	public class LiveRedirectScheduleEvent : BaseLiveScheduleEvent
	{
		#region Constants
		...
		public LiveRedirectScheduleEvent(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaLiveRedirectScheduleEvent");
