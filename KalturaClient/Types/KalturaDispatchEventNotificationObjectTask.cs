...
namespace Kaltura
{
	public class KalturaDispatchEventNotificationObjectTask : KalturaObjectTask
	{
		...
		public KalturaDispatchEventNotificationObjectTask(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIntIfNotNull("eventNotificationTemplateId", this.EventNotificationTemplateId);
			return kparams;
		}
		#endregion
	}
