...
{
	public class ExportTaskAddRequestBuilder : StandaloneRequestBuilder<ExportTask>
	{
		#region Constants
	...
	public class ExportTaskDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class ExportTaskGetRequestBuilder : StandaloneRequestBuilder<ExportTask>
	{
		#region Constants
		public const string ID = "id";
		#endregion
	...
	public class ExportTaskListRequestBuilder : StandaloneRequestBuilder<ListResponse<ExportTask>>
	{
		#region Constants
	...
	public class ExportTaskUpdateRequestBuilder : StandaloneRequestBuilder<ExportTask>
	{
		#region Constants
		public const string ID = "id";
		public const string TASK = "task";
