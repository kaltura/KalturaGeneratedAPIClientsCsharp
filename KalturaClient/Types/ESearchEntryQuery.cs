...
{
	public class ESearchEntryQuery : ESearchEntryBaseItem
	{
		#region Constants
		...
		public ESearchEntryQuery(XmlElement node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaESearchEntryQuery");
