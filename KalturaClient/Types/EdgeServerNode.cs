...
namespace Kaltura.Types
{
	public class EdgeServerNode : DeliveryServerNode
	{
		...
		#region Properties
		/// <summary>
		/// Use PlaybackDomainAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public EdgeServerNode(JToken node) : base(node)
		{
			if(node["playbackDomain"] != null)
			{
				this._PlaybackDomain = node["playbackDomain"].Value<string>();
			}
		}
		#endregion
