...
{
	public class UserAssetsListItemAddRequestBuilder : StandaloneRequestBuilder<UserAssetsListItem>
	{
		#region Constants
	...
	public class UserAssetsListItemDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class UserAssetsListItemGetRequestBuilder : StandaloneRequestBuilder<UserAssetsListItem>
	{
		#region Constants
		public const string ASSET_ID = "assetId";
		public const string LIST_TYPE = "listType";
