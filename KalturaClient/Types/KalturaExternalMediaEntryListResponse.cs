...
namespace Kaltura
{
	public class KalturaExternalMediaEntryListResponse : KalturaListResponse
	{
		...
		#region Properties
		public new IList<KalturaExternalMediaEntry> Objects
		{
			get { return _Objects; }
		}
		#endregion
		...
		public KalturaExternalMediaEntryListResponse(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "objects":
						this._Objects = new List<KalturaExternalMediaEntry>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._Objects.Add((KalturaExternalMediaEntry)KalturaObjectFactory.Create(arrayNode, "KalturaExternalMediaEntry"));
						}
						continue;
				}
			}
