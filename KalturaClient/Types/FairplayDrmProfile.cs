...
{
	public class FairplayDrmProfile : DrmProfile
	{
		#region Constants
		...
		#region Properties
		/// <summary>
		/// Use PublicCertificateAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public FairplayDrmProfile(JToken node) : base(node)
		{
			if(node["publicCertificate"] != null)
			{
				this._PublicCertificate = node["publicCertificate"].Value<string>();
			}
		}
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaFairplayDrmProfile");
