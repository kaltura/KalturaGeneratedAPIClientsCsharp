...
namespace Kaltura
{
	public class KalturaLimitFlavorsRestriction : KalturaBaseRestriction
	{
		#region Private Fields
		private KalturaLimitFlavorsRestrictionType _LimitFlavorsRestrictionType = (KalturaLimitFlavorsRestrictionType)Int32.MinValue;
		...
		public KalturaLimitFlavorsRestriction(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					case "limitFlavorsRestrictionType":
						this.LimitFlavorsRestrictionType = (KalturaLimitFlavorsRestrictionType)ParseEnum(typeof(KalturaLimitFlavorsRestrictionType), txt);
						continue;
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddEnumIfNotNull("limitFlavorsRestrictionType", this.LimitFlavorsRestrictionType);
