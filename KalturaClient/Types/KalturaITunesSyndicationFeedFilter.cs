...
namespace Kaltura
{
	public class KalturaITunesSyndicationFeedFilter : KalturaITunesSyndicationFeedBaseFilter
	{
		...
		#region Properties
		public KalturaITunesSyndicationFeedOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaITunesSyndicationFeedFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaITunesSyndicationFeedOrderBy)KalturaStringEnum.Parse(typeof(KalturaITunesSyndicationFeedOrderBy), txt);
						continue;
				}
			}
		}
