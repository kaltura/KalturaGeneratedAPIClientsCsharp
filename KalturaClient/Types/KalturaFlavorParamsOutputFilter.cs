...
namespace Kaltura
{
	public class KalturaFlavorParamsOutputFilter : KalturaFlavorParamsOutputBaseFilter
	{
		...
		#region Properties
		public KalturaFlavorParamsOutputOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaFlavorParamsOutputFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaFlavorParamsOutputOrderBy)KalturaStringEnum.Parse(typeof(KalturaFlavorParamsOutputOrderBy), txt);
						continue;
				}
			}
		}
