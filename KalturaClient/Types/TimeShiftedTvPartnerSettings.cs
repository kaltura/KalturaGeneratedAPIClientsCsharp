...
namespace Kaltura.Types
{
	public class TimeShiftedTvPartnerSettings : ObjectBase
	{
		...
		public const string CLEANUP_NOTICE_PEROID = "cleanupNoticePeroid";
		...
		private int _CleanupNoticePeroid = Int32.MinValue;
		...
		public int CleanupNoticePeroid
		{
			get { return _CleanupNoticePeroid; }
			set 
			{ 
				_CleanupNoticePeroid = value;
				OnPropertyChanged("CleanupNoticePeroid");
			}
		}
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				switch (propertyNode.Name)
				{
					...
					case "recordingLifetimePeriod":
						...
						continue;
					case "cleanupNoticePeroid":
						this._CleanupNoticePeroid = ParseInt(propertyNode.InnerText);
						continue;
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			kparams.AddIfNotNull("cleanupNoticePeroid", this._CleanupNoticePeroid);
		...
		protected override string getPropertyName(string apiName)
		{
			switch(apiName)
			{
				...
				case CLEANUP_NOTICE_PEROID:
					return "CleanupNoticePeroid";
