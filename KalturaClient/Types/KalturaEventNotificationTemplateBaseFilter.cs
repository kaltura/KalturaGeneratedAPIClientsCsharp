...
namespace Kaltura
{
	public class KalturaEventNotificationTemplateBaseFilter : KalturaFilter
	{
		...
		private KalturaEventNotificationTemplateType _TypeEqual = null;
		private string _TypeIn = null;
		private KalturaEventNotificationTemplateStatus _StatusEqual = (KalturaEventNotificationTemplateStatus)Int32.MinValue;
		...
		public KalturaEventNotificationTemplateBaseFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "systemNameIn":
						...
						continue;
					case "typeEqual":
						this._TypeEqual = (KalturaEventNotificationTemplateType)KalturaStringEnum.Parse(typeof(KalturaEventNotificationTemplateType), txt);
						continue;
					case "typeIn":
						this._TypeIn = txt;
						continue;
					case "statusEqual":
						this._StatusEqual = (KalturaEventNotificationTemplateStatus)ParseEnum(typeof(KalturaEventNotificationTemplateStatus), txt);
						continue;
					case "statusIn":
						this._StatusIn = txt;
						continue;
