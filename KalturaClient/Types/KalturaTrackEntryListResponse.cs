...
namespace Kaltura
{
	public class KalturaTrackEntryListResponse : KalturaListResponse
	{
		...
		#region Properties
		public new IList<KalturaTrackEntry> Objects
		{
			get { return _Objects; }
		}
		#endregion
		...
		public KalturaTrackEntryListResponse(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "objects":
						this._Objects = new List<KalturaTrackEntry>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._Objects.Add((KalturaTrackEntry)KalturaObjectFactory.Create(arrayNode, "KalturaTrackEntry"));
						}
						continue;
				}
			}
