...
namespace Kaltura
{
	public class KalturaRemoteDropFolderFilter : KalturaRemoteDropFolderBaseFilter
	{
		...
		#region Properties
		public KalturaRemoteDropFolderOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaRemoteDropFolderFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaRemoteDropFolderOrderBy)KalturaStringEnum.Parse(typeof(KalturaRemoteDropFolderOrderBy), txt);
						continue;
				}
			}
		}
