...
namespace Kaltura
{
	public class KalturaDistributionProfileFilter : KalturaDistributionProfileBaseFilter
	{
		...
		#region Properties
		public KalturaDistributionProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaDistributionProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaDistributionProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaDistributionProfileOrderBy), txt);
						continue;
				}
			}
		}
