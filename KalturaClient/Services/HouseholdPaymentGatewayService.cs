...
{
	public class HouseholdPaymentGatewayDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		...
		public HouseholdPaymentGatewayDeleteRequestBuilder()
			: base("householdpaymentgateway", "delete")
		{
		}

		public HouseholdPaymentGatewayDeleteRequestBuilder(int paymentGatewayId)
			: this()
		{
	...
	public class HouseholdPaymentGatewaySetRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string PAYMENT_GATEWAY_ID = "paymentGatewayId";
		#endregion
		...
		public HouseholdPaymentGatewaySetRequestBuilder()
			: base("householdpaymentgateway", "set")
		{
		}

		public HouseholdPaymentGatewaySetRequestBuilder(int paymentGatewayId)
			: this()
		{
			this.PaymentGatewayId = paymentGatewayId;
		}
	...
	public class HouseholdPaymentGatewayGetChargeIDRequestBuilder : StandaloneRequestBuilder<string>
	{
		#region Constants
	...
	public class HouseholdPaymentGatewayInvokeRequestBuilder : StandaloneRequestBuilder<PaymentGatewayConfiguration>
	{
		#region Constants
		public const string PAYMENT_GATEWAY_ID = "paymentGatewayId";
	...
	public class HouseholdPaymentGatewayListRequestBuilder : StandaloneRequestBuilder<ListResponse<HouseholdPaymentGateway>>
	{
		#region Constants
		#endregion
	...
	public class HouseholdPaymentGatewaySetChargeIDRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
		public const string PAYMENT_GATEWAY_EXTERNAL_ID = "paymentGatewayExternalId";
	...
	public class HouseholdPaymentGatewayService
	{
		...
		public static HouseholdPaymentGatewayDeleteRequestBuilder Delete(int paymentGatewayId)
		{
			return new HouseholdPaymentGatewayDeleteRequestBuilder(paymentGatewayId);
		}

		public static HouseholdPaymentGatewaySetRequestBuilder Set(int paymentGatewayId)
		{
			return new HouseholdPaymentGatewaySetRequestBuilder(paymentGatewayId);
		}
