			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "systemNameIn":
						...
						continue;
					case "typeEqual":
						this.TypeEqual = (KalturaEventNotificationTemplateType)KalturaStringEnum.Parse(typeof(KalturaEventNotificationTemplateType), txt);
						continue;
					case "typeIn":
						this.TypeIn = txt;
						continue;
					case "statusEqual":
						this.StatusEqual = (KalturaEventNotificationTemplateStatus)ParseEnum(typeof(KalturaEventNotificationTemplateStatus), txt);
						continue;
					case "statusIn":
						this.StatusIn = txt;
						continue;
