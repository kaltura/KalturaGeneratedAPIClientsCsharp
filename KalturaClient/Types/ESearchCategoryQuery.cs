...
{
	public class ESearchCategoryQuery : ESearchCategoryBaseItem
	{
		#region Constants
		...
		public ESearchCategoryQuery(XmlElement node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaESearchCategoryQuery");
