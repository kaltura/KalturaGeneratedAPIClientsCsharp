...
{
	public class MeetingScheduleEvent : EntryScheduleEvent
	{
		#region Constants
		...
		public MeetingScheduleEvent(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaMeetingScheduleEvent");
