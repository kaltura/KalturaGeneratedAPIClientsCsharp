...
namespace Kaltura
{
	public class KalturaLiveEntryServerNode : KalturaEntryServerNode
	{
		#region Private Fields
		private IList<KalturaLiveStreamParams> _Streams;
		#endregion
		...
		public KalturaLiveEntryServerNode(XmlElement node) : base(node)
		{
