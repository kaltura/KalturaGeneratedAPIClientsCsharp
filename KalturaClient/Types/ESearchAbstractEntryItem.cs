...
{
	public class ESearchAbstractEntryItem : ESearchEntryBaseItem
	{
		#region Constants
		...
		public ESearchAbstractEntryItem(XmlElement node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaESearchAbstractEntryItem");
