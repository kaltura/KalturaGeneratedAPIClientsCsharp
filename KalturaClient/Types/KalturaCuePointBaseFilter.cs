...
namespace Kaltura
{
	public class KalturaCuePointBaseFilter : KalturaFilter
	{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIntIfNotNull("triggeredAtGreaterThanOrEqual", this.TriggeredAtGreaterThanOrEqual);
			kparams.AddIntIfNotNull("triggeredAtLessThanOrEqual", this.TriggeredAtLessThanOrEqual);
