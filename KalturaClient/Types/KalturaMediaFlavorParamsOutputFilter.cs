...
namespace Kaltura
{
	public class KalturaMediaFlavorParamsOutputFilter : KalturaMediaFlavorParamsOutputBaseFilter
	{
		...
		#region Properties
		public KalturaMediaFlavorParamsOutputOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaMediaFlavorParamsOutputFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaMediaFlavorParamsOutputOrderBy)KalturaStringEnum.Parse(typeof(KalturaMediaFlavorParamsOutputOrderBy), txt);
						continue;
				}
			}
		}
