...
namespace Kaltura
{
	public class KalturaEventObjectChangedCondition : KalturaCondition
	{
		...
		public KalturaEventObjectChangedCondition(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddStringIfNotNull("modifiedColumns", this.ModifiedColumns);
			return kparams;
		}
		#endregion
	}
