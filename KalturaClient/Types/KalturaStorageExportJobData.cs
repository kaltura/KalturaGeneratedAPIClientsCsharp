...
namespace Kaltura
{
	public class KalturaStorageExportJobData : KalturaStorageJobData
	{
		...
		public KalturaStorageExportJobData(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddBoolIfNotNull("force", this.Force);
			kparams.AddBoolIfNotNull("createLink", this.CreateLink);
			return kparams;
		}
		#endregion
	}
