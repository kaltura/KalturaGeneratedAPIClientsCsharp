...
namespace Kaltura
{
	public class KalturaPdfFlavorParamsOutputFilter : KalturaPdfFlavorParamsOutputBaseFilter
	{
		...
		#region Properties
		public KalturaPdfFlavorParamsOutputOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaPdfFlavorParamsOutputFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaPdfFlavorParamsOutputOrderBy)KalturaStringEnum.Parse(typeof(KalturaPdfFlavorParamsOutputOrderBy), txt);
						continue;
				}
			}
		}
