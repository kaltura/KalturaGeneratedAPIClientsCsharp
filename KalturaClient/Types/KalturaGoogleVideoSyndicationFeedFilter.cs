...
namespace Kaltura
{
	public class KalturaGoogleVideoSyndicationFeedFilter : KalturaGoogleVideoSyndicationFeedBaseFilter
	{
		...
		#region Properties
		public KalturaGoogleVideoSyndicationFeedOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaGoogleVideoSyndicationFeedFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaGoogleVideoSyndicationFeedOrderBy)KalturaStringEnum.Parse(typeof(KalturaGoogleVideoSyndicationFeedOrderBy), txt);
						continue;
				}
			}
		}
