...
{
	public class DeleteFileJobData : JobData
	{
		#region Constants
		public const string LOCAL_FILE_SYNC_PATH = "localFileSyncPath";
		#endregion

		#region Private Fields
		private string _LocalFileSyncPath = null;
		#endregion

		#region Properties
		/// <summary>
		/// Use LocalFileSyncPathAsDouble property instead
		/// </summary>
		[JsonProperty]
		public string LocalFileSyncPath
		{
			...
			set 
			{ 
				_LocalFileSyncPath = value;
				OnPropertyChanged("LocalFileSyncPath");
			}
		}
		#endregion
		...
		protected override string getPropertyName(string apiName)
		{
			switch(apiName)
			{
				case LOCAL_FILE_SYNC_PATH:
					return "LocalFileSyncPath";
				default:
