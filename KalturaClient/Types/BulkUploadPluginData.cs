...
{
	public class BulkUploadPluginData : ObjectBase
	{
		#region Constants
		...
		public BulkUploadPluginData(XmlElement node) : base(node)
		{
		...
		public BulkUploadPluginData(IDictionary<string,object> data) : base(data)
		{
