...
{
	public class SearchMatchCondition : SearchCondition
	{
		#region Constants
		...
		public SearchMatchCondition(XmlElement node) : base(node)
		{
		...
		public SearchMatchCondition(IDictionary<string,object> data) : base(data)
		{
