...
{
	public class PodcastDistributionProfile : DistributionProfile
	{
		#region Constants
		...
		public PodcastDistributionProfile(XmlElement node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaPodcastDistributionProfile");
			kparams.AddIfNotNull("xsl", this._Xsl);
			kparams.AddIfNotNull("feedId", this._FeedId);
