...
{
	public class ESearchOperator : ESearchBaseItem
	{
		#region Constants
		...
		private IList<ESearchBaseItem> _SearchItems;
		#endregion
		...
		public IList<ESearchBaseItem> SearchItems
		{
		...
		public ESearchOperator(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				switch (propertyNode.Name)
				{
					case "operator":
						...
						continue;
					case "searchItems":
						this._SearchItems = new List<ESearchBaseItem>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this._SearchItems.Add(ObjectFactory.Create<ESearchBaseItem>(arrayNode));
						}
						continue;
				}
			}
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaESearchOperator");
