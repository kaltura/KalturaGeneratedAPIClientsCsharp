...
namespace Kaltura
{
	public class KalturaBaseEntryCloneOptions : KalturaObjectBase
	{
		...
		public KalturaBaseEntryCloneOptions(XmlElement node) : base(node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddReplace("objectType", "KalturaBaseEntryCloneOptions");
