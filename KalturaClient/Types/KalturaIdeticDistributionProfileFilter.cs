...
namespace Kaltura
{
	public class KalturaIdeticDistributionProfileFilter : KalturaIdeticDistributionProfileBaseFilter
	{
		...
		#region Properties
		public KalturaIdeticDistributionProfileOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaIdeticDistributionProfileFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaIdeticDistributionProfileOrderBy)KalturaStringEnum.Parse(typeof(KalturaIdeticDistributionProfileOrderBy), txt);
						continue;
				}
			}
		}
