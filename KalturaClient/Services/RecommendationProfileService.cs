...
{
	public class RecommendationProfileAddRequestBuilder : StandaloneRequestBuilder<RecommendationProfile>
	{
		#region Constants
	...
	public class RecommendationProfileDeleteRequestBuilder : StandaloneRequestBuilder<bool>
	{
		#region Constants
	...
	public class RecommendationProfileGenerateSharedSecretRequestBuilder : StandaloneRequestBuilder<RecommendationProfile>
	{
		#region Constants
	...
	public class RecommendationProfileListRequestBuilder : StandaloneRequestBuilder<ListResponse<RecommendationProfile>>
	{
		#region Constants
		#endregion
	...
	public class RecommendationProfileUpdateRequestBuilder : StandaloneRequestBuilder<RecommendationProfile>
	{
		#region Constants
		public const string RECOMMENDATION_ENGINE_ID = "recommendationEngineId";
		public const string RECOMMENDATION_ENGINE = "recommendationEngine";
