...
namespace Kaltura
{
	public sealed class KalturaCuePointOrderBy : KalturaStringEnum
	{
		...
		public static readonly KalturaCuePointOrderBy TRIGGERED_AT_ASC = new KalturaCuePointOrderBy("+triggeredAt");
		...
		public static readonly KalturaCuePointOrderBy TRIGGERED_AT_DESC = new KalturaCuePointOrderBy("-triggeredAt");
