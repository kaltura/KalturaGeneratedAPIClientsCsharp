...
namespace Kaltura
{
	public class KalturaDropFolderFileBaseFilter : KalturaFilter
	{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIntIfNotNull("leadDropFolderFileIdEqual", this.LeadDropFolderFileIdEqual);
			kparams.AddIntIfNotNull("deletedDropFolderFileIdEqual", this.DeletedDropFolderFileIdEqual);
