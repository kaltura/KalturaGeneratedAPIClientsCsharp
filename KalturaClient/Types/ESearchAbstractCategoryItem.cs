...
{
	public class ESearchAbstractCategoryItem : ESearchCategoryBaseItem
	{
		#region Constants
		...
		public ESearchAbstractCategoryItem(XmlElement node) : base(node)
		{
		...
		public ESearchAbstractCategoryItem(IDictionary<string,object> data) : base(data)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaESearchAbstractCategoryItem");
