...
namespace Kaltura
{
	public class KalturaBaseSyndicationFeedFilter : KalturaBaseSyndicationFeedBaseFilter
	{
		...
		#region Properties
		public KalturaBaseSyndicationFeedOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaBaseSyndicationFeedFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaBaseSyndicationFeedOrderBy)KalturaStringEnum.Parse(typeof(KalturaBaseSyndicationFeedOrderBy), txt);
						continue;
				}
			}
		}
