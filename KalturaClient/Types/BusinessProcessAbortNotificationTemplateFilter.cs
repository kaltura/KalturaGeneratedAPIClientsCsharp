...
namespace Kaltura.Types
{
	public class BusinessProcessAbortNotificationTemplateFilter : BusinessProcessAbortNotificationTemplateBaseFilter
	{
		...
		public BusinessProcessAbortNotificationTemplateFilter(JToken node) : base(node)
		{
			if(node["orderBy"] != null)
			{
				this._OrderBy = (BusinessProcessAbortNotificationTemplateOrderBy)StringEnum.Parse(typeof(BusinessProcessAbortNotificationTemplateOrderBy), node["orderBy"].Value<string>());
			}
		}
		#endregion
