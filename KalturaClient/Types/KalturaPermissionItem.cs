...
namespace Kaltura
{
	public class KalturaPermissionItem : KalturaObjectBase
	{
		...
		public KalturaPermissionItem(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					case "id":
						...
						continue;
					case "type":
						this._Type = (KalturaPermissionItemType)KalturaStringEnum.Parse(typeof(KalturaPermissionItemType), txt);
						continue;
					case "partnerId":
