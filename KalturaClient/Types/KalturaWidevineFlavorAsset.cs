...
namespace Kaltura
{
	public class KalturaWidevineFlavorAsset : KalturaFlavorAsset
	{
		...
		public KalturaWidevineFlavorAsset(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "widevineAssetId":
						this.WidevineAssetId = ParseInt(txt);
						continue;
				}
			}
		}
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIntIfNotNull("widevineAssetId", this.WidevineAssetId);
			return kparams;
		}
		#endregion
	}
