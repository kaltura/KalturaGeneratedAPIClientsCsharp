...
{
	public class BeaconScheduledResourceOperator : BeaconScheduledResourceBaseItem
	{
		#region Constants
		...
		private IList<BeaconScheduledResourceBaseItem> _SearchItems;
		#endregion
		...
		/// </summary>
		[JsonProperty]
		public IList<BeaconScheduledResourceBaseItem> SearchItems
		{
		...
		public BeaconScheduledResourceOperator(JToken node) : base(node)
		{
			...
			{
				this._SearchItems = new List<BeaconScheduledResourceBaseItem>();
				foreach(var arrayNode in node["searchItems"].Children())
				{
					this._SearchItems.Add(ObjectFactory.Create<BeaconScheduledResourceBaseItem>(arrayNode));
				}
			}
		}
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaBeaconScheduledResourceOperator");
