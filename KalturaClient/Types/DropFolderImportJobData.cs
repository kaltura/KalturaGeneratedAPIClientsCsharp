...
{
	public class DropFolderImportJobData : SshImportJobData
	{
		#region Constants
		...
		public DropFolderImportJobData(XmlElement node) : base(node)
		{
		...
		public DropFolderImportJobData(IDictionary<string,object> data) : base(data)
		{
