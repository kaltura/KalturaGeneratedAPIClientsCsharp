			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "partnerId":
						...
						continue;
					case "status":
						this._Status = (KalturaUserEntryStatus)KalturaStringEnum.Parse(typeof(KalturaUserEntryStatus), txt);
						continue;
					case "createdAt":
					...
					case "updatedAt":
						...
						continue;
					case "type":
						this._Type = (KalturaUserEntryType)KalturaStringEnum.Parse(typeof(KalturaUserEntryType), txt);
						continue;
				}
			}
		}
