...
namespace Kaltura
{
	public class KalturaBatchJobBaseFilter : KalturaFilter
	{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddIfNotNull("idGreaterThanOrEqual", this.IdGreaterThanOrEqual);
			kparams.AddIfNotNull("partnerIdEqual", this.PartnerIdEqual);
			kparams.AddIfNotNull("partnerIdIn", this.PartnerIdIn);
			kparams.AddIfNotNull("partnerIdNotIn", this.PartnerIdNotIn);
			...
			kparams.AddIfNotNull("executionAttemptsGreaterThanOrEqual", this.ExecutionAttemptsGreaterThanOrEqual);
			kparams.AddIfNotNull("executionAttemptsLessThanOrEqual", this.ExecutionAttemptsLessThanOrEqual);
			kparams.AddIfNotNull("lockVersionGreaterThanOrEqual", this.LockVersionGreaterThanOrEqual);
			kparams.AddIfNotNull("lockVersionLessThanOrEqual", this.LockVersionLessThanOrEqual);
			kparams.AddIfNotNull("entryIdEqual", this.EntryIdEqual);
			kparams.AddIfNotNull("jobTypeEqual", this.JobTypeEqual);
			kparams.AddIfNotNull("jobTypeIn", this.JobTypeIn);
			kparams.AddIfNotNull("jobTypeNotIn", this.JobTypeNotIn);
			kparams.AddIfNotNull("jobSubTypeEqual", this.JobSubTypeEqual);
			kparams.AddIfNotNull("jobSubTypeIn", this.JobSubTypeIn);
			kparams.AddIfNotNull("jobSubTypeNotIn", this.JobSubTypeNotIn);
			...
			kparams.AddIfNotNull("priorityNotIn", this.PriorityNotIn);
			kparams.AddIfNotNull("batchVersionGreaterThanOrEqual", this.BatchVersionGreaterThanOrEqual);
			kparams.AddIfNotNull("batchVersionLessThanOrEqual", this.BatchVersionLessThanOrEqual);
			kparams.AddIfNotNull("batchVersionEqual", this.BatchVersionEqual);
			kparams.AddIfNotNull("queueTimeGreaterThanOrEqual", this.QueueTimeGreaterThanOrEqual);
			kparams.AddIfNotNull("queueTimeLessThanOrEqual", this.QueueTimeLessThanOrEqual);
			kparams.AddIfNotNull("finishTimeGreaterThanOrEqual", this.FinishTimeGreaterThanOrEqual);
			kparams.AddIfNotNull("finishTimeLessThanOrEqual", this.FinishTimeLessThanOrEqual);
			kparams.AddIfNotNull("errTypeEqual", this.ErrTypeEqual);
			kparams.AddIfNotNull("errTypeIn", this.ErrTypeIn);
			kparams.AddIfNotNull("errTypeNotIn", this.ErrTypeNotIn);
			kparams.AddIfNotNull("errNumberEqual", this.ErrNumberEqual);
			kparams.AddIfNotNull("errNumberIn", this.ErrNumberIn);
			kparams.AddIfNotNull("errNumberNotIn", this.ErrNumberNotIn);
			kparams.AddIfNotNull("estimatedEffortLessThan", this.EstimatedEffortLessThan);
			kparams.AddIfNotNull("estimatedEffortGreaterThan", this.EstimatedEffortGreaterThan);
			kparams.AddIfNotNull("urgencyLessThanOrEqual", this.UrgencyLessThanOrEqual);
			kparams.AddIfNotNull("urgencyGreaterThanOrEqual", this.UrgencyGreaterThanOrEqual);
			return kparams;
		}
		#endregion
	}
