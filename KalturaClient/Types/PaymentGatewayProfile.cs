...
namespace Kaltura.Types
{
	public class PaymentGatewayProfile : PaymentGatewayBaseProfile
	{
		...
		public const string PAYMENT_GATEWAYE_SETTINGS = "paymentGatewayeSettings";
		...
		private IDictionary<string, StringValue> _PaymentGatewayeSettings;
		...
		public IDictionary<string, StringValue> PaymentGatewayeSettings
		{
			get { return _PaymentGatewayeSettings; }
			set 
			{ 
				_PaymentGatewayeSettings = value;
				OnPropertyChanged("PaymentGatewayeSettings");
			}
		}
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				switch (propertyNode.Name)
				{
					...
					case "renewUrl":
						...
						continue;
					case "paymentGatewayeSettings":
						{
							string key;
							this._PaymentGatewayeSettings = new Dictionary<string, StringValue>();
							foreach(XmlElement arrayNode in propertyNode.ChildNodes)
							{
								key = arrayNode["itemKey"].InnerText;;
								this._PaymentGatewayeSettings[key] = ObjectFactory.Create<StringValue>(arrayNode);
							}
						}
						continue;
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			kparams.AddIfNotNull("paymentGatewayeSettings", this._PaymentGatewayeSettings);
		...
		protected override string getPropertyName(string apiName)
		{
			switch(apiName)
			{
				...
				case RENEW_URL:
					return "RenewUrl";
				case PAYMENT_GATEWAYE_SETTINGS:
					return "PaymentGatewayeSettings";
