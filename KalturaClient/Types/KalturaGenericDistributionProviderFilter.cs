...
namespace Kaltura
{
	public class KalturaGenericDistributionProviderFilter : KalturaGenericDistributionProviderBaseFilter
	{
		...
		#region Properties
		public KalturaGenericDistributionProviderOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaGenericDistributionProviderFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaGenericDistributionProviderOrderBy)KalturaStringEnum.Parse(typeof(KalturaGenericDistributionProviderOrderBy), txt);
						continue;
				}
			}
		}
