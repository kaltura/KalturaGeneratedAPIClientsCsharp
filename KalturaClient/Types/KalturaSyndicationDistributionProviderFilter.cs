...
namespace Kaltura
{
	public class KalturaSyndicationDistributionProviderFilter : KalturaSyndicationDistributionProviderBaseFilter
	{
		...
		#region Properties
		public KalturaSyndicationDistributionProviderOrderBy OrderBy
		{
			get { return _OrderBy; }
			set 
			{ 
		...
		public KalturaSyndicationDistributionProviderFilter(XmlElement node) : base(node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "orderBy":
						this._OrderBy = (KalturaSyndicationDistributionProviderOrderBy)KalturaStringEnum.Parse(typeof(KalturaSyndicationDistributionProviderOrderBy), txt);
						continue;
				}
			}
		}
