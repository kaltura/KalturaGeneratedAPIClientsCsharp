...
{
	public class YahooDistributionProviderFilter : YahooDistributionProviderBaseFilter
	{
		#region Constants
		...
		private YahooDistributionProviderOrderBy _OrderBy = null;
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaYahooDistributionProviderFilter");
