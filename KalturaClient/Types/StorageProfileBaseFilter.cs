			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "systemNameIn":
						...
						continue;
					case "statusEqual":
						this._StatusEqual = (StorageProfileStatus)ParseEnum(typeof(StorageProfileStatus), txt);
						continue;
					case "statusIn":
						this._StatusIn = txt;
						continue;
					case "protocolEqual":
						this._ProtocolEqual = (StorageProfileProtocol)StringEnum.Parse(typeof(StorageProfileProtocol), txt);
						continue;
					case "protocolIn":
