...
namespace Kaltura
{
	public class KalturaEntryScheduleEventFilter : KalturaEntryScheduleEventBaseFilter
	{
		...
		private KalturaEntryScheduleEventOrderBy _OrderBy = null;
		#endregion
		...
		public KalturaEntryScheduleEventFilter(XmlElement node) : base(node)
		{
